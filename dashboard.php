...
<head>
  <meta charset="UTF-8">
  <title>OnTrac Mailing Services</title>
  ...
  <div class="left">
    <div class="sidebar">
      <div class="wrapper">
        ...
        <div class="items">
          <a href="#" class="addon"><img src="https://i.ibb.co/L8D5T60/light.png" /></a>
          <a href="#" class="addon"><img src="https://i.ibb.co/zmDbMVZ/diamond.png" /></a>
          <a href="#" class="addon"><img src="https://i.ibb.co/W5QZ9Fk/envelope.png" /></a>
          <a href="#" class="addon"><img src="https://i.ibb.co/CnKDBxC/flask.png" /></a>
          <a href="#" class="addon"><img src="https://i.ibb.co/MGs4Fyn/sent-mail.png" /></a>
          <a href="#" class="addon"><img src="https://i.ibb.co/zGtDpcp/map.png" /></a>
        </div>
        <div class="profile">
    ...
    <div class="navigation">
      <div class="wrapper2">
        <div class="welcome">
        <h4>Welcome, <?php echo $row['name']; ?></h4><br>
        </div>
        <button class="compose">Compose Mail 
         <span class="plus">
  ...
  <div class="right-side">
    <div class="right-header">
      <div class="top-bar">
        ...
        <div class="profile2">
          <img src="https://www.seekclipart.com/clipng/middle/103-1032140_graphic-transparent-1-vector-flat-small-user-icon.png" />
          <div class="icon-name5"> <a href="index.php">Logout </a></div>
        </div>
      </div>
      <hr class="new-hr">
    ...
    <div class="right-body">
      <div class="scroll-cards">
        <div class="card">
          <div class="mails">
          <span class="person border1"> P </span>
        ...
        <div class="card">
          <div class="mails">
            <span class="person border1"> G</span>
            <div class="mail-names">
              GCTU
            </div>
      ...
      <div class="message">
        ...
        <div class="from">
          <span class="who">From: </span>info@critacgh.com
        </div>
